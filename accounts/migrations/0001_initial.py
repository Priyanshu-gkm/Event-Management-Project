    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fname', models.CharField(max_length=30, verbose_name='first_name')),
                ('lname', models.CharField(max_length=30, verbose_name='last_name')),
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('ATTENDEE', 'Attendee'), ('ORGANIZER', 'Organizer'), ('OTHERS', 'Others')], default='OTHERS', max_length=50)),
