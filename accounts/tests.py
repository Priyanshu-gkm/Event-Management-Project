...
class TestAccountViews(TestCase):
    ...
    def setUp(self):
        ...
        self.attendee_user = Account.objects.create_user(email="attendeeTest1@gmail.com",
        ...
        self.organizer_user = Account.objects.create_user(email="organizerTest@gmail.com",
        ...
        self.admin_user =  Account.objects.create_user(email="adminTest@gmail.com",
                    username = "adminTest",
                    password= "admin",
                    fname= "admin",
                    lname= "admin",
        ...
        self.attendee_data =json.dumps({'username' :  'attendeeTest', 'password' : 'Test@Abcd'})
        self.organizer_data =json.dumps({'username' :  'organizerTest', 'password' : 'Test@Abcd'})
        
        response = self.client.post(reverse("user_login"),data=self.admin_data,content_type='application/json')
        self.admin_token = response.json()['token']
        
        response = self.client.post(reverse("user_login"),data=self.attendee_data,content_type='application/json')
        self.attendee_token = response.json()['token']
       
        response = self.client.post(reverse("user_login"),data=self.organizer_data,content_type='application/json')
    ...
    def test_AccountRetrieveView_Get_fail(self):
        # id not found
        response = self.client.get(reverse('RUD_account',args=[self.random_id]),HTTP_AUTHORIZATION=f'Token {self.admin_token}')
    ...
    def test_AccountRetrieveView_Get_pass_admin(self):
        ...
        response = self.client.get(reverse('RUD_account',args=[self.attendee_id]),HTTP_AUTHORIZATION=f'Token {self.admin_token}')
        self.assertEqual(response.status_code,200)
        
    def test_AccountRetrieveView_Get_fail_org(self):
        # id found
        # organizer cant see any other account
        response = self.client.get(reverse('RUD_account',args=[self.attendee_id]),HTTP_AUTHORIZATION=f'Token {self.organizer_token}')
    ...
    def test_AccountRetrieveView_Get_pass_org(self):
        ...
        response = self.client.get(reverse('RUD_account',args=[self.organizer_id]),HTTP_AUTHORIZATION=f'Token {self.organizer_token}')
        self.assertEqual(response.status_code,200)
        
    def test_AccountRetrieveView_Get_fail_att(self):
        # id found
        # attendee cant see any other account
        response = self.client.get(reverse('RUD_account',args=[self.organizer_id]),HTTP_AUTHORIZATION=f'Token {self.attendee_token}')
        self.assertEqual(response.status_code,403)
    ...
    def test_AccountRetrieveView_Get_pass_att(self):
        ...
        response = self.client.get(reverse('RUD_account',args=[self.attendee_id]),HTTP_AUTHORIZATION=f'Token {self.attendee_token}')
        self.assertEqual(response.status_code,200)
    ...
    def test_AccountUpdateView_PATCH_fail_att(self):
        ...
        response = self.client.patch(reverse('RUD_account',args=[self.organizer_id]),data=data,HTTP_AUTHORIZATION=f'Token {self.attendee_token}')
        self.assertEquals(response.status_code, 403)
    ...
    def test_AccountUpdateView_PATCH_pass_org(self):
        ...
        response = self.client.patch(reverse('RUD_account',args=[self.organizer_id]),data=data,HTTP_AUTHORIZATION=f'Token {self.organizer_token}',content_type='application/json')
        self.assertEquals(response.status_code, 200)
    ...
    def test_AccountUpdateView_PATCH_pass_admin(self):
        ...
        response = self.client.patch(reverse('RUD_account',args=[self.organizer_id]),data=data,HTTP_AUTHORIZATION=f'Token {self.admin_token}',content_type='application/json')
        self.assertEquals(response.status_code, 200)
    ...
    def test_AccountDeleteView_DELETE_fail(self):
        ...
        response = self.client.delete(reverse('RUD_account',args=[self.random_id]),HTTP_AUTHORIZATION=f'Token {self.admin_token}')
        self.assertEqual(response.status_code,404)
    ...
    def test_AccountDeleteView_DELETE_fail_att_other(self):
        # attendee should not be able to delete any account other than self
        # must be logged in
        response = self.client.delete(reverse('RUD_account',args=[self.organizer_id]),HTTP_AUTHORIZATION=f'Token {self.attendee_token}')
        self.assertEqual(response.status_code,403)
    ...
    def test_AccountDeleteView_DELETE_pass_att_self(self):
        ...
        response = self.client.delete(reverse('RUD_account',args=[self.attendee_id]),HTTP_AUTHORIZATION=f'Token {self.attendee_token}')
    ...
    def test_AccountDeleteView_DELETE_pass_org_admin(self):
        ...
        response = self.client.delete(reverse('RUD_account',args=[self.organizer_id]),HTTP_AUTHORIZATION=f'Token {self.admin_token}')
        self.assertEqual(response.status_code,204)
